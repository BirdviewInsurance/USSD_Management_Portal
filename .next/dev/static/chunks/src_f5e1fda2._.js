...
(()=>{
    const e = new Error("Cannot find module '@/lib/navigation'");
...
function Button(t0) {
    ...
    if ($[0] !== "1932eb4278587b7952ecfb74a748c95443696dad4e8117d2feabcc471a9ec11f") {
        for(let $i = 0; $i < 29; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "1932eb4278587b7952ecfb74a748c95443696dad4e8117d2feabcc471a9ec11f";
    }
    let children;
    let className;
    let href;
...
// src/components/layout/Sidebar.tsx - Update navigation items
__turbopack_context__.s([
    "Sidebar",
    ()=>Sidebar
]);
...
const navItems = [
    {
        ...
        sections: [
            {
                label: 'Stats',
                href: navigation.sections.dashboard.stats
            },
            {
                label: 'Overview',
                href: navigation.sections.dashboard.overview
            },
            {
                label: 'Recent',
                href: navigation.sections.dashboard.recent
            },
            {
                label: 'Actions',
                href: navigation.sections.dashboard.actions
            }
        ]
    },
    {
        ...
        sections: [
            {
                label: 'Overview',
                href: navigation.sections.providers.overview
            },
            {
                label: 'List',
                href: navigation.sections.providers.list
            },
            {
                label: 'Add',
                href: navigation.sections.providers.add
            }
        ]
    },
    {
        ...
        sections: [
            {
                label: 'Stats',
                href: navigation.sections.billing.stats
            },
            {
                label: 'Invoices',
                href: navigation.sections.billing.invoices
            },
            {
                label: 'Payments',
                href: navigation.sections.billing.payments
            },
            {
                label: 'Create',
                href: navigation.sections.billing.create
            }
        ]
    }
];
function Sidebar() {
    ...
    if ($[0] !== "afcf90eef9375eb5ed9c64df80663279e3a67c122a65d5db2383c0270cf8e5fe") {
        for(let $i = 0; $i < 75; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "afcf90eef9375eb5ed9c64df80663279e3a67c122a65d5db2383c0270cf8e5fe";
    }
...
function Header() {
    ...
    if ($[0] !== "d8ffef1f3f7b023093ecc3d66451b041fbe8721d25ed573bf2652b885e71fef4") {
        for(let $i = 0; $i < 26; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "d8ffef1f3f7b023093ecc3d66451b041fbe8721d25ed573bf2652b885e71fef4";
    }
    let t0;
    if ($[1] === Symbol.for("react.memo_cache_sentinel")) {
        t0 = [
...
//# sourceMappingURL=src_f5e1fda2._.js.map